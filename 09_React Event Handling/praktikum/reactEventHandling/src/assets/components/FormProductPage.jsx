        ...
        <div className="container mx-auto px-10 mx-10 mb-10">
          <form id="formCreateProduct">
            ...
            <div className="flex justify-center mt-2 pb-10">
              <button id="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-full">
                Submit
              </button>
            </div>
            <div className="flex justify-center mt-2 pb-10">
              <button id="submit" onClick={generateRandomNumber} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-full">
                Random Number
              </button>
            </div>
          </form>
